const projetos = [
  { id:1, 
   ...
   { id:3,
    ...
    descricao:['Desafio: Criar cópia do site da Starbucks para por em prática conhecimento em Grids.', 'Solução: Utilizar CSS com Grids para criar interface responsiva e moderna', 'Resultado: Consolidei a capacidade de desenvolver sites responsivos e bem estruturados usando CSS Grid.'],
